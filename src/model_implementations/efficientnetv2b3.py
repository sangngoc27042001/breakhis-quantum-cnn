"""
EfficientNetV2B3 model implementation for BreakHis classification.
"""
...
def build_model(num_classes: int = None,
    ...
    # Base model: EfficientNetV2B3 (pretrained on ImageNet)
    ...
    # Create model
    model = Model(inputs=inputs, outputs=outputs, name='EfficientNetV2B3_BreakHis')
